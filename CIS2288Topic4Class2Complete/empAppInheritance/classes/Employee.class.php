...
class Employee
{
     ...
     *
     * Employee.class.class constructor.
     * @param $empNum
     * @param $empLastName
     * @param $empFirstName
     * @param $empSalary
     */
    /*public function Employee.class.class($empLastName, $empFirstName, $empSalary)
    {
    ...
    {
        return "<br/>Employee.class  Number:  " . $this->empNum
            . "<br />Employee.class  Name:  " . $this->empFirstName . " " . $this->empLastName
            . "<br />Salary:  " . number_format($this->empSalary,2) . "<br/>";
    }
